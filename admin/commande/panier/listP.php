  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div>
            <a href="../listC.php" class="btn btn-outline-primary">Retourner</a>
        </div>
      </div>
      <div>
        <?php
            echo '
                 <h6>Client : '.$v_nom.'  '.$v_prenom.'</h6>
            ';
        ?>
                                ...
                                if($p['Panier'] == $c){
                                    echo '
                                        <tr>
                                            <th scope="row">'.$i.'</th>
                                            <td>'.$p['Nom'].'</td>
                                            <td><img src= "../../../images/'.$p['Image'].'" width="50" height="50"></td>
                                            <td>'.$p['Quantité'].'</td>
                                        </tr>
                                    ';
                                }      
