  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="listCa.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div>
            <a href="ajoutCa.php" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Ajouter</a>
        </div>
      </div>
      <?php
        ...
        if(isset($_GET['supprimer']) && $_GET['supprimer']=="ok"){
          echo '
            <div class="alert alert-success">
              Catégorie suprimée avec succés
            </div>
          ';
        }
        if(isset($_GET['modifier']) && $_GET['modifier']=="ok"){
          echo '
            <div class="alert alert-success">
              Mise à jour de catégorie avec succés
            </div>
          ';
        }
      ?>
                    ...
                    <?php
                        ...
                        foreach($categorie as $categorie){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="modifierForm.php?id='.$categorie['ID'].'" class="btn btn-outline-success">Modifier</a>
                                    <a onClick="return popUpDeleteCategorie()"  href="supprimerCa.php?id='.$categorie['ID'].'" class="btn btn-outline-danger">Supprimer</a>
                                </td>
                            </tr>
                            ';
                        }
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="ajoutCa.php" method="post">
        <div class="modal-body">
        
          <div class="form-group mb-4">

              <input type="text" name="Nom" class="form-control" placeholder="Nom de catégories ...">
          </div>

          <div class="form-group mb-4">

              <textarea name="Description" class="form-control" placeholder="Description de catégories ..."></textarea>
          </div>
        </div>
